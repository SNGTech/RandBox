...
namespace RandBox.Server.Data.Migrations
{
    ...
    [Migration("20240120081008_cascadedeleteorderitem2")]
    partial class cascadedeleteorderitem2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 10, 8, 630, DateTimeKind.Local).AddTicks(7961),
                        ...
                        new
                        {
                            CategoryID = 2,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 10, 8, 630, DateTimeKind.Local).AddTicks(7963),
                        ...
                        new
                        {
                            CategoryID = 3,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 10, 8, 630, DateTimeKind.Local).AddTicks(7965),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 10, 8, 631, DateTimeKind.Local).AddTicks(217),
                        ...
                        new
                        {
                            CountryID = 2,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 10, 8, 631, DateTimeKind.Local).AddTicks(219),
                        ...
                        new
                        {
                            CountryID = 3,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 10, 8, 631, DateTimeKind.Local).AddTicks(220),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 10, 8, 630, DateTimeKind.Local).AddTicks(7004),
                        ...
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 10, 8, 630, DateTimeKind.Local).AddTicks(7062),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            DateTimeCheckout = new DateTime(2024, 1, 20, 16, 10, 8, 630, DateTimeKind.Local).AddTicks(9135),
                            DeliveryStatus = true,
                            StaffID = 1
                        },
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            DateTimeCheckout = new DateTime(2024, 1, 20, 16, 10, 8, 630, DateTimeKind.Local).AddTicks(9138),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionPlanID = 1,
                            CustomerID = 1,
                            SubscribedDateTime = new DateTime(2024, 1, 20, 16, 10, 8, 631, DateTimeKind.Local).AddTicks(542),
                            SubscriptionCategoryID = 12
                        },
                        new
                        {
                            SubscriptionPlanID = 2,
                            CustomerID = 2,
                            SubscribedDateTime = new DateTime(2023, 11, 20, 16, 10, 8, 631, DateTimeKind.Local).AddTicks(561),
                            SubscriptionCategoryID = 5
                        });
                });
