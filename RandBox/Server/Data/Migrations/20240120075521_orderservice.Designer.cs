...
namespace RandBox.Server.Data.Migrations
{
    ...
    [Migration("20240120075521_orderservice")]
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(3116),
                        ...
                        new
                        {
                            CategoryID = 2,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(3119),
                        ...
                        new
                        {
                            CategoryID = 3,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(3120),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(4668),
                        ...
                        new
                        {
                            CountryID = 2,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(4671),
                        ...
                        new
                        {
                            CountryID = 3,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(4673),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(2673),
                        ...
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(2689),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            DateTimeCheckout = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(3875),
                            DeliveryStatus = true,
                            StaffID = 1
                        },
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            DateTimeCheckout = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(3879),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionPlanID = 1,
                            CustomerID = 1,
                            SubscribedDateTime = new DateTime(2024, 1, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(4909),
                            SubscriptionCategoryID = 12
                        },
                        new
                        {
                            SubscriptionPlanID = 2,
                            CustomerID = 2,
                            SubscribedDateTime = new DateTime(2023, 11, 20, 15, 55, 21, 307, DateTimeKind.Local).AddTicks(4913),
                            SubscriptionCategoryID = 5
                        });
                });
