...
namespace RandBox.Server.Data.Migrations
{
    ...
    [Migration("20240120081604_cascadedeleteorderitem3")]
    partial class cascadedeleteorderitem3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(2874),
                        ...
                        new
                        {
                            CategoryID = 2,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(2875),
                        ...
                        new
                        {
                            CategoryID = 3,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(2876),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(3767),
                        ...
                        new
                        {
                            CountryID = 2,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(3769),
                        ...
                        new
                        {
                            CountryID = 3,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(3770),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(2620),
                        ...
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(2632),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            DateTimeCheckout = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(3345),
                            DeliveryStatus = true,
                            StaffID = 1
                        },
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            DateTimeCheckout = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(3346),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionPlanID = 1,
                            CustomerID = 1,
                            SubscribedDateTime = new DateTime(2024, 1, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(3931),
                            SubscriptionCategoryID = 12
                        },
                        new
                        {
                            SubscriptionPlanID = 2,
                            CustomerID = 2,
                            SubscribedDateTime = new DateTime(2023, 11, 20, 16, 16, 4, 132, DateTimeKind.Local).AddTicks(3934),
                            SubscriptionCategoryID = 5
                        });
                });
