...
namespace RandBox.Server.Data.Migrations
{
    ...
    [Migration("20231221033045_FixedModels_1")]
    partial class FixedModels_1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2023, 12, 21, 11, 30, 44, 915, DateTimeKind.Local).AddTicks(9569),
                        ...
                        new
                        {
                            CategoryID = 2,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2023, 12, 21, 11, 30, 44, 915, DateTimeKind.Local).AddTicks(9571),
                        ...
                        new
                        {
                            CategoryID = 3,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2023, 12, 21, 11, 30, 44, 915, DateTimeKind.Local).AddTicks(9572),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2023, 12, 21, 11, 30, 44, 916, DateTimeKind.Local).AddTicks(624),
                        ...
                        new
                        {
                            CountryID = 2,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2023, 12, 21, 11, 30, 44, 916, DateTimeKind.Local).AddTicks(625),
                        ...
                        new
                        {
                            CountryID = 3,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2023, 12, 21, 11, 30, 44, 916, DateTimeKind.Local).AddTicks(626),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2023, 12, 21, 11, 30, 44, 915, DateTimeKind.Local).AddTicks(9314),
                        ...
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2023, 12, 21, 11, 30, 44, 915, DateTimeKind.Local).AddTicks(9331),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            DateTimeCheckout = new DateTime(2023, 12, 21, 11, 30, 44, 916, DateTimeKind.Local).AddTicks(185),
                            DeliveryStatus = true,
                            StaffID = 1
                        },
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            DateTimeCheckout = new DateTime(2023, 12, 21, 11, 30, 44, 916, DateTimeKind.Local).AddTicks(187),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustID = 1,
                            SubscribedDateTime = new DateTime(2023, 12, 21, 11, 30, 44, 915, DateTimeKind.Local).AddTicks(9892),
                            SubscriptionCategoryID = 12
                        },
                        new
                        {
                            ...
                            CustID = 2,
                            SubscribedDateTime = new DateTime(2023, 10, 21, 11, 30, 44, 915, DateTimeKind.Local).AddTicks(9895),
                            SubscriptionCategoryID = 5
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    b.HasOne("RandBox.Shared.Domain.Customer", "Customers")
                        .WithMany()
