...
namespace RandBox.Server.Data.Migrations
{
    ...
    [Migration("20231222032850_AddedIdentityRoles")]
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(6572),
                        ...
                        new
                        {
                            CategoryID = 2,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(6574),
                        ...
                        new
                        {
                            CategoryID = 3,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(6575),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(7827),
                        ...
                        new
                        {
                            CountryID = 2,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(7829),
                        ...
                        new
                        {
                            CountryID = 3,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(7830),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(6299),
                        ...
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(6309),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            DateTimeCheckout = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(7286),
                            DeliveryStatus = true,
                            StaffID = 1
                        },
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            DateTimeCheckout = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(7287),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustID = 1,
                            SubscribedDateTime = new DateTime(2023, 12, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(6965),
                            SubscriptionCategoryID = 12
                        },
                        new
                        {
                            ...
                            CustID = 2,
                            SubscribedDateTime = new DateTime(2023, 10, 22, 11, 28, 50, 830, DateTimeKind.Local).AddTicks(6966),
                            SubscriptionCategoryID = 5
                        });
                });
