...
namespace RandBox.Server.Migrations
{
    ...
    [Migration("20240204094018_newprod")]
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 40, 18, 344, DateTimeKind.Local).AddTicks(4717),
                        ...
                        new
                        {
                            CategoryID = 2,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 40, 18, 344, DateTimeKind.Local).AddTicks(4719),
                        ...
                        new
                        {
                            CategoryID = 3,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 40, 18, 344, DateTimeKind.Local).AddTicks(4787),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 40, 18, 522, DateTimeKind.Local).AddTicks(921),
                        ...
                        new
                        {
                            CountryID = 2,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 40, 18, 522, DateTimeKind.Local).AddTicks(925),
                        ...
                        new
                        {
                            CountryID = 3,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 40, 18, 522, DateTimeKind.Local).AddTicks(928),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 40, 18, 228, DateTimeKind.Local).AddTicks(8933),
                            Email = "cout.sngtech@gmail.com",
                            FirstName = "Titus",
                            LastName = "Lim",
                            PasswordHash = "AQAAAAIAAYagAAAAEALNGncqMoYMfMb0GIDmIlB6/sPJeT45Yp3I/NBuvASkYWNtjoiODPxDQIDWENwxjg==",
                            PostalCode = "342352",
                            UnitNo = "04-06"
                        },
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 40, 18, 284, DateTimeKind.Local).AddTicks(1651),
                            Email = "patrick_wu@gmail.com",
                            FirstName = "Patrick",
                            LastName = "Wu",
                            PasswordHash = "AQAAAAIAAYagAAAAEH0hYxKJisCj/3dK6sxz/Sa8xt0DQsizWwCQjbywgtEm7ogzdaQgc7aoAeQc5lb+wg==",
                            PostalCode = "442532",
                            UnitNo = "23-45"
                        },
                        new
                        {
                            ...
                            Address = "Hoppa Avenue 8",
                            DateOfBirth = new DateTime(2005, 4, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 40, 18, 344, DateTimeKind.Local).AddTicks(3100),
                            Email = "e@gmail.com",
                            FirstName = "Kelyn",
                            LastName = "Neo",
                            PasswordHash = "AQAAAAIAAYagAAAAEEGR+uSn2mLTSpVkcT5T2os3/+b35Vg7JbhGdCbAXo7S3DK98D9CQVN5n7AdqxuInA==",
                            PostalCode = "442532",
                            UnitNo = "23-45"
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            DateTimeCheckout = new DateTime(2024, 2, 4, 17, 40, 18, 521, DateTimeKind.Local).AddTicks(9639),
                            DeliveryStatus = true,
                            StaffID = 1
                        },
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            DateTimeCheckout = new DateTime(2024, 2, 4, 17, 40, 18, 521, DateTimeKind.Local).AddTicks(9658),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Name = "Trachten",
                            OriginalPrice = 10.21m,
                            ThumbnailURL = "data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAkGBwgHBgkIBwgKCgkLDRYPDQwMDRsUFRAWIB0iIiAdHx8kKDQsJCYxJx8fLT0tMTU3Ojo6Iys/RD84QzQ"
                        },
                        new
                        {
                            ProductID = 9,
                        ...
                        new
                        {
                            ...
                            Name = "Belangkon",
                            OriginalPrice = 10.21m,
                            ThumbnailURL = "\",\r\n"
                        },
                        new
                        {
                            ProductID = 12,
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Shan",
                            LastName = "Lim",
                            PasswordHash = "AQAAAAIAAYagAAAAEDEC1+rxscnda//4gfn8PQ/fh4Nw+lx3YM4il8BwSnDxqKAj+ZKPvzgAEVVZMdoMNQ=="
                        },
                        new
                        {
                            StaffID = 2,
                            ...
                            FirstName = "Atu",
                            LastName = "Triyoso",
                            PasswordHash = "AQAAAAIAAYagAAAAEIiRigMqCjB583e7jOyiQXAl0d5IOXGQYVMONhsAeOtzIF5QLKLOjvhJY1ENfj6xcw=="
                        },
                        new
                        {
                            StaffID = 3,
                            ...
                            FirstName = "Wei",
                            LastName = "Hanh",
                            PasswordHash = "AQAAAAIAAYagAAAAEMbUzYL64IfQTkIwfKAGzEk3TbsmL733+5xThBtPpZy7cOcgW6ra90YzMnjM9ZJyCQ=="
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionPlanID = 1,
                            CustomerID = 1,
                            SubscribedDateTime = new DateTime(2024, 2, 4, 17, 40, 18, 522, DateTimeKind.Local).AddTicks(1328),
                            SubscriptionCategoryID = 12
                        },
                        new
                        {
                            SubscriptionPlanID = 2,
                            CustomerID = 2,
                            SubscribedDateTime = new DateTime(2023, 12, 4, 17, 40, 18, 522, DateTimeKind.Local).AddTicks(1336),
                            SubscriptionCategoryID = 5
                        });
                });
