...
namespace RandBox.Server.Migrations
{
    ...
    [Migration("20240204085835_newcuststaff")]
    partial class newcuststaff
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 2, 4, 16, 58, 35, 509, DateTimeKind.Local).AddTicks(8394),
                        ...
                        new
                        {
                            CategoryID = 2,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 2, 4, 16, 58, 35, 509, DateTimeKind.Local).AddTicks(8398),
                        ...
                        new
                        {
                            CategoryID = 3,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 2, 4, 16, 58, 35, 509, DateTimeKind.Local).AddTicks(8399),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 2, 4, 16, 58, 35, 690, DateTimeKind.Local).AddTicks(6935),
                        ...
                        new
                        {
                            CountryID = 2,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 2, 4, 16, 58, 35, 690, DateTimeKind.Local).AddTicks(6941),
                        ...
                        new
                        {
                            CountryID = 3,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 2, 4, 16, 58, 35, 690, DateTimeKind.Local).AddTicks(6942),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 2, 4, 16, 58, 35, 398, DateTimeKind.Local).AddTicks(231),
                            Email = "cout.sngtech@gmail.com",
                            FirstName = "Titus",
                            LastName = "Lim",
                            PasswordHash = "AQAAAAIAAYagAAAAELhLtAkpcLRN2A+oVadICTMPH2BsCsemNchSBGq0jXHL3QrRwQXBn7vu9HUhDbki+Q==",
                            PostalCode = "342352",
                            UnitNo = "04-06"
                        },
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 2, 4, 16, 58, 35, 453, DateTimeKind.Local).AddTicks(6748),
                            Email = "patrick_wu@gmail.com",
                            FirstName = "Patrick",
                            LastName = "Wu",
                            PasswordHash = "AQAAAAIAAYagAAAAEAXUJsWAxEIQRilPDgyxccnvl3aD6lJssx0zLPJD2uQaLIlTumpJgmJKXaQ3U5IQuA==",
                            PostalCode = "442532",
                            UnitNo = "23-45"
                        },
                        new
                        {
                            ...
                            Address = "Hoppa Avenue 8",
                            DateOfBirth = new DateTime(2005, 4, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateTimeCreated = new DateTime(2024, 2, 4, 16, 58, 35, 509, DateTimeKind.Local).AddTicks(7039),
                            Email = "e@gmail.com",
                            FirstName = "Kelyn",
                            LastName = "Neo",
                            PasswordHash = "AQAAAAIAAYagAAAAENkm3SD2NentfA5j2AiROJx9jpVpewGmE0S24uBjVnF5wa3Qvo6qbenQ8+5tCxy5+Q==",
                            PostalCode = "442532",
                            UnitNo = "23-45"
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            DateTimeCheckout = new DateTime(2024, 2, 4, 16, 58, 35, 690, DateTimeKind.Local).AddTicks(1713),
                            DeliveryStatus = true,
                            StaffID = 1
                        },
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            DateTimeCheckout = new DateTime(2024, 2, 4, 16, 58, 35, 690, DateTimeKind.Local).AddTicks(1730),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Shan",
                            LastName = "Lim",
                            PasswordHash = "AQAAAAIAAYagAAAAEEI4BJyIwjcVTcBWApEnpWzI1bar3TWvbRNk3q5c48QvEuSJYfOn7TkZatC3fFLzkw=="
                        },
                        new
                        {
                            StaffID = 2,
                            ...
                            FirstName = "Atu",
                            LastName = "Triyoso",
                            PasswordHash = "AQAAAAIAAYagAAAAEBCTtdx1J+kjJVloGB4u19itDwmK4SprNcK3iH8Up/sZGzUyT6uXyRBM9UD+c+kLCA=="
                        },
                        new
                        {
                            StaffID = 3,
                            ...
                            FirstName = "Wei",
                            LastName = "Hanh",
                            PasswordHash = "AQAAAAIAAYagAAAAEGpwSjlbJdPSfUVfz5crudtiI7jXBgXzzaRLQqOjepvYa2/lPP2+heoIuohzqf6LLg=="
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionPlanID = 1,
                            CustomerID = 1,
                            SubscribedDateTime = new DateTime(2024, 2, 4, 16, 58, 35, 690, DateTimeKind.Local).AddTicks(8487),
                            SubscriptionCategoryID = 12
                        },
                        new
                        {
                            SubscriptionPlanID = 2,
                            CustomerID = 2,
                            SubscribedDateTime = new DateTime(2023, 12, 4, 16, 58, 35, 690, DateTimeKind.Local).AddTicks(8495),
                            SubscriptionCategoryID = 5
                        });
                });
