...
namespace RandBox.Server.Migrations
{
    ...
    [Migration("20240204100056_prod2")]
    partial class prod2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 2, 4, 18, 0, 56, 290, DateTimeKind.Local).AddTicks(8563),
                        ...
                        new
                        {
                            CategoryID = 2,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 2, 4, 18, 0, 56, 290, DateTimeKind.Local).AddTicks(8565),
                        ...
                        new
                        {
                            CategoryID = 3,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 2, 4, 18, 0, 56, 290, DateTimeKind.Local).AddTicks(8603),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 2, 4, 18, 0, 56, 461, DateTimeKind.Local).AddTicks(4812),
                        ...
                        new
                        {
                            CountryID = 2,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 2, 4, 18, 0, 56, 461, DateTimeKind.Local).AddTicks(4816),
                        ...
                        new
                        {
                            CountryID = 3,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 2, 4, 18, 0, 56, 461, DateTimeKind.Local).AddTicks(4817),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 2, 4, 18, 0, 56, 173, DateTimeKind.Local).AddTicks(1814),
                            Email = "cout.sngtech@gmail.com",
                            FirstName = "Titus",
                            LastName = "Lim",
                            PasswordHash = "AQAAAAIAAYagAAAAEInRzsMD7EoRcRj+BLtlWnKPVhA+5qTqAdvSrYCKfz/sguZAtJiGIHxsyPTeIUWPkA==",
                            PostalCode = "342352",
                            UnitNo = "04-06"
                        },
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 2, 4, 18, 0, 56, 228, DateTimeKind.Local).AddTicks(618),
                            Email = "patrick_wu@gmail.com",
                            FirstName = "Patrick",
                            LastName = "Wu",
                            PasswordHash = "AQAAAAIAAYagAAAAEC4ZCwVIkgscc4oCZoff/IjUIErd9ocdCZ3Q7zJIpU/bpqjDko9gsd1wDOu/WG1uNQ==",
                            PostalCode = "442532",
                            UnitNo = "23-45"
                        },
                        new
                        {
                            ...
                            Address = "Hoppa Avenue 8",
                            DateOfBirth = new DateTime(2005, 4, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateTimeCreated = new DateTime(2024, 2, 4, 18, 0, 56, 290, DateTimeKind.Local).AddTicks(7415),
                            Email = "e@gmail.com",
                            FirstName = "Kelyn",
                            LastName = "Neo",
                            PasswordHash = "AQAAAAIAAYagAAAAEDEFtJWgpL2DssY2IlIFLoA4M6vvt5g2I8WyWP0JLyBUXNXI6zjTv2Gt+vCCtiYWiA==",
                            PostalCode = "442532",
                            UnitNo = "23-45"
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            DateTimeCheckout = new DateTime(2024, 2, 4, 18, 0, 56, 461, DateTimeKind.Local).AddTicks(3758),
                            DeliveryStatus = true,
                            StaffID = 1
                        },
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            DateTimeCheckout = new DateTime(2024, 2, 4, 18, 0, 56, 461, DateTimeKind.Local).AddTicks(3774),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Shan",
                            LastName = "Lim",
                            PasswordHash = "AQAAAAIAAYagAAAAEJhlS5RxhQt7UYMVeUQckpb/NE4fDcfgqny4ijPoA2WxWLoVjlzVNpN/E+eSuWyjoA=="
                        },
                        new
                        {
                            StaffID = 2,
                            ...
                            FirstName = "Atu",
                            LastName = "Triyoso",
                            PasswordHash = "AQAAAAIAAYagAAAAEKqUul/zYX19q8aYS9Yuw1p55SfaU4MSngXmH/BjYjobjspIBFURxG9YxbCF4J6IAw=="
                        },
                        new
                        {
                            StaffID = 3,
                            ...
                            FirstName = "Wei",
                            LastName = "Hanh",
                            PasswordHash = "AQAAAAIAAYagAAAAECf51IW5H3qj558ufhz3OCONfeef4zQaZilGLNyzSCez2T7p14BbBVsSpcDp9GtoDQ=="
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionPlanID = 1,
                            CustomerID = 1,
                            SubscribedDateTime = new DateTime(2024, 2, 4, 18, 0, 56, 461, DateTimeKind.Local).AddTicks(7455),
                            SubscriptionCategoryID = 12
                        },
                        new
                        {
                            SubscriptionPlanID = 2,
                            CustomerID = 2,
                            SubscribedDateTime = new DateTime(2023, 12, 4, 18, 0, 56, 461, DateTimeKind.Local).AddTicks(7512),
                            SubscriptionCategoryID = 5
                        });
                });
