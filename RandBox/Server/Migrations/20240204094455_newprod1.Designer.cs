...
namespace RandBox.Server.Migrations
{
    ...
    [Migration("20240204094455_newprod1")]
    partial class newprod1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 44, 54, 892, DateTimeKind.Local).AddTicks(2915),
                        ...
                        new
                        {
                            CategoryID = 2,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 44, 54, 892, DateTimeKind.Local).AddTicks(2919),
                        ...
                        new
                        {
                            CategoryID = 3,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 44, 54, 892, DateTimeKind.Local).AddTicks(2920),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 44, 55, 87, DateTimeKind.Local).AddTicks(3658),
                        ...
                        new
                        {
                            CountryID = 2,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 44, 55, 87, DateTimeKind.Local).AddTicks(3661),
                        ...
                        new
                        {
                            CountryID = 3,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 44, 55, 87, DateTimeKind.Local).AddTicks(3662),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 44, 54, 777, DateTimeKind.Local).AddTicks(1236),
                            Email = "cout.sngtech@gmail.com",
                            FirstName = "Titus",
                            LastName = "Lim",
                            PasswordHash = "AQAAAAIAAYagAAAAECNKmZ+WcUa5KuB+VOl2JErZEg4hv+99Ko8fRrSnEEe5R4DzYxlbxqnfd/kLX+5wlA==",
                            PostalCode = "342352",
                            UnitNo = "04-06"
                        },
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 44, 54, 833, DateTimeKind.Local).AddTicks(7390),
                            Email = "patrick_wu@gmail.com",
                            FirstName = "Patrick",
                            LastName = "Wu",
                            PasswordHash = "AQAAAAIAAYagAAAAELrl07Z2XkZeMrztk0ipQlflT5MAQ9Uxvja9FCysG8n9bEyIsKXbplZqCk6K2Xz9JQ==",
                            PostalCode = "442532",
                            UnitNo = "23-45"
                        },
                        new
                        {
                            ...
                            Address = "Hoppa Avenue 8",
                            DateOfBirth = new DateTime(2005, 4, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateTimeCreated = new DateTime(2024, 2, 4, 17, 44, 54, 892, DateTimeKind.Local).AddTicks(2058),
                            Email = "e@gmail.com",
                            FirstName = "Kelyn",
                            LastName = "Neo",
                            PasswordHash = "AQAAAAIAAYagAAAAEGGolBdONmvf2HXZkgzHztZwZ5SJPgRADcNCneG7glLdRXe9/bdi+5+syxKaj5AzWg==",
                            PostalCode = "442532",
                            UnitNo = "23-45"
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            DateTimeCheckout = new DateTime(2024, 2, 4, 17, 44, 55, 87, DateTimeKind.Local).AddTicks(2848),
                            DeliveryStatus = true,
                            StaffID = 1
                        },
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            DateTimeCheckout = new DateTime(2024, 2, 4, 17, 44, 55, 87, DateTimeKind.Local).AddTicks(2868),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Shan",
                            LastName = "Lim",
                            PasswordHash = "AQAAAAIAAYagAAAAELpx3jbhRwvjxCHt/+6JCWZ+rwCpE5eom0ANMZMOWw4gW1lV0erZ0Qvxq4TL7zpyfQ=="
                        },
                        new
                        {
                            StaffID = 2,
                            ...
                            FirstName = "Atu",
                            LastName = "Triyoso",
                            PasswordHash = "AQAAAAIAAYagAAAAEO6jlTZHRvX3FJyDEj7NDeEm79GaUUQZmyRcoPrxe9eTAO8pY9Z2x6/etvkwrbrGxw=="
                        },
                        new
                        {
                            StaffID = 3,
                            ...
                            FirstName = "Wei",
                            LastName = "Hanh",
                            PasswordHash = "AQAAAAIAAYagAAAAEB9Ffj+eBaE2sljNXZhQKixGdpmLU9FfTX2VIgEHLFf4rwTMYYE9sUrIP71eLEW62g=="
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionPlanID = 1,
                            CustomerID = 1,
                            SubscribedDateTime = new DateTime(2024, 2, 4, 17, 44, 55, 87, DateTimeKind.Local).AddTicks(3866),
                            SubscriptionCategoryID = 12
                        },
                        new
                        {
                            SubscriptionPlanID = 2,
                            CustomerID = 2,
                            SubscribedDateTime = new DateTime(2023, 12, 4, 17, 44, 55, 87, DateTimeKind.Local).AddTicks(3872),
                            SubscriptionCategoryID = 5
                        });
                });
