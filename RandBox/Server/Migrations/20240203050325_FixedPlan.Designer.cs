...
namespace RandBox.Server.Migrations
{
    ...
    [Migration("20240203050325_FixedPlan")]
    partial class FixedPlan
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 2, 3, 13, 3, 24, 878, DateTimeKind.Local).AddTicks(8562),
                        ...
                        new
                        {
                            CategoryID = 2,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 2, 3, 13, 3, 24, 878, DateTimeKind.Local).AddTicks(8564),
                        ...
                        new
                        {
                            CategoryID = 3,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 2, 3, 13, 3, 24, 878, DateTimeKind.Local).AddTicks(8565),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryID = 1,
                            BadgeColour = "#78A54E",
                            DateTimeCreated = new DateTime(2024, 2, 3, 13, 3, 24, 964, DateTimeKind.Local).AddTicks(9391),
                        ...
                        new
                        {
                            CountryID = 2,
                            BadgeColour = "#D45A50",
                            DateTimeCreated = new DateTime(2024, 2, 3, 13, 3, 24, 964, DateTimeKind.Local).AddTicks(9392),
                        ...
                        new
                        {
                            CountryID = 3,
                            BadgeColour = "#D48250",
                            DateTimeCreated = new DateTime(2024, 2, 3, 13, 3, 24, 964, DateTimeKind.Local).AddTicks(9393),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 2, 3, 13, 3, 24, 834, DateTimeKind.Local).AddTicks(8539),
                            Email = "cout.sngtech@gmail.com",
                            FirstName = "Titus",
                            LastName = "Lim",
                            PasswordHash = "AQAAAAIAAYagAAAAEID7Q/1SnG6Rt1yYrZP13RPmr32gGKnlPMYKOAVpfoMEYv11xju7C8ww7J/JxAxwag==",
                            PostalCode = "342352",
                            UnitNo = "04-06"
                        },
                        new
                        {
                            ...
                            DateTimeCreated = new DateTime(2024, 2, 3, 13, 3, 24, 878, DateTimeKind.Local).AddTicks(7522),
                            Email = "patrick_wu@gmail.com",
                            FirstName = "Patrick",
                            LastName = "Wu",
                            PasswordHash = "AQAAAAIAAYagAAAAEB7z/noJAczqYv3zJE10y1HeZN/PQAQkOn1zO0KbJuSXAzmF1+X7rgKCg9H/d06Yug==",
                            PostalCode = "442532",
                            UnitNo = "23-45"
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            DateTimeCheckout = new DateTime(2024, 2, 3, 13, 3, 24, 964, DateTimeKind.Local).AddTicks(8763),
                            DeliveryStatus = true,
                            StaffID = 1
                        },
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            DateTimeCheckout = new DateTime(2024, 2, 3, 13, 3, 24, 964, DateTimeKind.Local).AddTicks(8777),
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Shan",
                            LastName = "Lim",
                            PasswordHash = "AQAAAAIAAYagAAAAEN33HpDd4T7ZJkX3Hy6LghWeA9/3JfLKIOvUkgNDGPvNFqZjSAg0p3wq678iQmxAYw=="
                        },
                        new
                        {
                            StaffID = 2,
                            ...
                            FirstName = "Atu",
                            LastName = "Triyoso",
                            PasswordHash = "AQAAAAIAAYagAAAAEEr1TEmyJGOFRDQxNSRVDLmBZAwnbMs+BbXQ/kHcj9KOqjzf2pyoSqvM1zC5Y4VMsg=="
                        });
                });
            ...
            modelBuilder.Entity("RandBox.Shared.Domain.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionPlanID = 1,
                            CustomerID = 1,
                            SubscribedDateTime = new DateTime(2024, 2, 3, 13, 3, 24, 964, DateTimeKind.Local).AddTicks(9548),
                            SubscriptionCategoryID = 12
                        },
                        new
                        {
                            SubscriptionPlanID = 2,
                            CustomerID = 2,
                            SubscribedDateTime = new DateTime(2023, 12, 3, 13, 3, 24, 964, DateTimeKind.Local).AddTicks(9550),
                            SubscriptionCategoryID = 5
                        });
                });
